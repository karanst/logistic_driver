 ...
 final _otpController =  TextEditingController();
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(item?.onDate.toString().substring(0, 10) ??
                                '-'),
                          ],
                        ),
                        Column(
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        item?.status == '0' ? const SizedBox() : Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text(
                              "Transfer Parcel",
                    ...
                    item?.status == '0' ? Row(
                      ...
                      children: [
                        ...
                        OTPField(controller: _otpController, onTap: () { orderPickedOrCompleteByOtp(_otpController.text,'5'); },),
                        const SizedBox(width: 5,)
                        //FourDigitOtpFormField(onSaved: (String ) {  },),
                        //dropDown(index),
                      ],
                    ...
                    item?.status == '0' ? SizedBox.shrink() : Align(
  ...
  void completeOrder() async {
    ...
    try {
      ...
      body[RequestKeys.deliveryBoyOrderStatus] = '1';
      body[RequestKeys.deliveryTime] = DateTime.now().toString();
  ...
  void orderPickedOrCompleteByOtp(String otp , String status) async {
     if(otp.isEmpty){
      ...
      var request = http.MultipartRequest(
          'POST',
          Uri.parse(
              'https://developmentalphawizz.com/JDX/api/Authentication/otp_order_complete'));
